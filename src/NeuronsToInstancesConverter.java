...
public abstract class NeuronsToInstancesConverter {
    ...
    protected Instances convert(DefaultNetwork network, String datasetName){
	
	Instances instances = new Instances(datasetName, createTweetAttributes() , network.getNumbersOfNeurons());
