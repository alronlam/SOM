...
public class DatasetManagerFactory {
    ...
    private static final String INTERNET_DATA_ORIGINAL = "data/dataset.csv";
    private static final String INTERNET_DATA_WO_CLASSES = "data/dataset_wo_class.csv";
	...
	switch(type){
        	...
        	case INTERNET: return new DatasetManager(INTERNET_DATA_ORIGINAL, INTERNET_DATA_WO_CLASSES, 0);
	}
	return null;
    }
